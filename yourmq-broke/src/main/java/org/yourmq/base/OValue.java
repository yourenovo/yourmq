...
public class OValue {
    ...
    public void set(Object val) {
        if (val == null) {
            ...
            throw new YourSocketException("Unsupport type, class: " + val.getClass().getName());
        }
    }
    ...
    public boolean isEmpty() {
        return this._type == OValueType.String ? StringUtil.isEmpty(this._string) : this.isNull();
    }
